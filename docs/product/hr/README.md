...
| **HR-07** | **Puantaj / Attendance (operational monthly result)** — **Accepted / Completed**. HR-07A + HR-07B are the approved MVP. Deferred: PDKS/punch, period lock, official holiday engine, half-day/Partial, overtime/payroll/SGK | sketched as **HR-08** Attendance in older Personel Master planning; later Accepted texts already call future actuals **HR-07** |
| **HR-08** | **Personel Hareketleri / Workforce Movements** — domain **Accepted** (2026-09-04). **HR-08A** foundation **Accepted / Completed**. **HR-08 overall In Progress** until **HR-08B** (top-level UI / card history; not implemented). Companion [ADR-012](../../architecture/adr/ADR-012-Workforce-Movements-And-Reporting-Line.md) — **Accepted**. Older Personel Master used **HR-08** for Attendance; ADR-011 still names a later overtime consumer “HR-08” — those Accepted texts are **not rewritten** | sketched as later Assignment / promotion UI (**HR-05** in older Personel Master planning) |
...
HR-07 discovery: [HR-07-PUANTAJ-DISCOVERY.md](HR-07-PUANTAJ-DISCOVERY.md) — **Accepted / Completed** (2026-09-03). Companion: [ADR-011](../../architecture/adr/ADR-011-Puantaj-Domain-Model.md) — **Accepted**. HR-07A backend foundation and HR-07B monthly grid/sidebar are **Completed / Accepted**. The operational MVP is closed; PDKS/punch, period lock, official holiday engine, half-day/Partial, and overtime/payroll/SGK remain deferred. WebİK remains reference only. Puantaj is a top-level operational module, not a Personnel Card tab.

HR-08 discovery: [HR-08-PERSONEL-HAREKETLERI-DISCOVERY.md](HR-08-PERSONEL-HAREKETLERI-DISCOVERY.md) — **Accepted** (2026-09-04). Companion: [ADR-012](../../architecture/adr/ADR-012-Workforce-Movements-And-Reporting-Line.md) — **Accepted**. Q1–Q10 frozen. **HR-08A** (entities, engine, APIs, authorization, live same-Organization PropertyTransfer) is **Accepted / Completed** (2026-09-04). **HR-08 remains In Progress** because HR-08B UI is deferred and not present. WebİK remains reference only. Personel Hareketleri is a top-level operational module, not a Personnel Card tab, and is **not** WebİK TimeCore punch “Personel Hareketleri.”
