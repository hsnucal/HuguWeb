...
HR-08 discovery: [HR-08-PERSONEL-HAREKETLERI-DISCOVERY.md](HR-08-PERSONEL-HAREKETLERI-DISCOVERY.md) — **Accepted** (2026-09-04). Companion: [ADR-012](../../architecture/adr/ADR-012-Workforce-Movements-And-Reporting-Line.md) — **Accepted**. Q1–Q10 frozen. **HR-08A:** **Completed**. **HR-08B:** **Accepted / Completed**. **HR-08 overall:** **Completed**. WebİK remains reference only. Personel Hareketleri is a top-level operational module, not a Personnel Card tab, and is **not** WebİK TimeCore punch “Personel Hareketleri.”
