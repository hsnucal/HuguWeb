...
| Uyruk | Nationality | ISO 3166-1 alpha-2 (`TR`) | no | EmployeeHrProfile | A | Sensitive | No | Restricted | Restricted | **HR-03B PO amendment 2026-08-24:** stored identity is ISO alpha-2 (not localized name). Column remains string(64). Complete officially assigned catalogue. HR-01B allowed working string; going-forward validation is ISO. | Ref; KBS/İŞKUR prep |
