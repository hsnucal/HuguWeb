...
const errorKeys: Record<string, string> = {
  ...
  'movement-same-target': 'workforce.errors.sameAssignment',
  'movement-pending-leave-conflict': 'workforce.errors.pendingLeaveConflict',
  'movement-schedule-conflict': 'workforce.errors.scheduleConflict',
  'movement-property-access-denied': 'workforce.errors.propertyAccessDenied',
  'movement-position-not-applicable': 'personnel.validation.positionNotAvailable',
