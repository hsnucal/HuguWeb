...
public sealed class Department
{
    ...
    private Department(Guid id, Guid propertyId, string name, string? code, bool isActive)
    {
        Id = id;
        ...
        out string? error)
    {
        ...
        department = new Department(id, propertyId, normalizedName, normalizedCode, isActive: true);
        return true;
    }
    ...
    public static bool TryNormalizeName(string? name, out string normalized, out string? error)
    {
        ...
        {
            error = $"Department name must be {NameMaxLength} characters or fewer.";
            return false;
        }
    ...
    public static bool TryNormalizeCode(string? code, out string? normalized, out string? error)
    {
        ...
        {
            normalized = null;
            error = $"Department code must be {CodeMaxLength} characters or fewer.";
            return false;
        }
