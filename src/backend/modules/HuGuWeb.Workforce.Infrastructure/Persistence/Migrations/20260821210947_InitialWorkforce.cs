        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Employments_EndedHasEndDate", "\"Status\" <> 'Ended' OR \"EndDate\" IS NOT NULL");
                    table.CheckConstraint("CK_Employments_Period", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Assignments_Period", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_EmploymentId_Kind_StartDate",
                table: "Assignments",
                columns: new[] { "EmploymentId", "Kind", "StartDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_OrganizationId_PersonnelNumber",
                table: "Employees",
